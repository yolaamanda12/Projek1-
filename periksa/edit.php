                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="berat" name="berat" type="number" class="form-control" value="<?= $row['berat'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tinggi" class="col-4 col-form-label">Tinggi Badan</label>
                                    <div class="col-8">
                                        <input id="tinggi" name="tinggi" type="number" class="form-control" value="<?= $row['tinggi'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="keterangan" class="col-4 col-form-label">Keterangan Periksa</label>
                                    <div class="col-8">
                                        <textarea name="keterangan" id="keterangan" cols="30" rows="5" class="form-control" value="<?= $row['keterangan'] ?>">
                                        </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select id="pasien_id" name="pasien_id" class="custom-select">
                                            ...
                                            foreach ($rsjenis as $rowjenis) {
                                                ...
                                                echo "<option value='" . $rowjenis['id'] . "' $selected>" . $rowjenis['kode'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
