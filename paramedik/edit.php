                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                    ...
                                    <div class="col-8">
                                        <select id="kategori" name="kategori" class="custom-select">
                                            ...
                                            foreach ($rsjenis as $rowjenis) {
                                                $selected = ($row['kategori'] == $rowjenis['id']) ? 'selected' : '';
                                                echo "<option value='" . $rowjenis['id'] . "' $selected>" . $rowjenis['kategori'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="telpon" name="telpon" type="number" class="form-control" value="<?= $row['telpon'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
